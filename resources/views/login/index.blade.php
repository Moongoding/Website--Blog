        ...
        <main class="form-signin w-100 m-auto serif">
            <form autocomplete="on" action="/login" method="post">
                ...
                <div class="form-floating">
                    <input type="email" name="email" class="form-control rounded-top @error('email') is-invalid @enderror " id="email" placeholder="email" autofocus required value="{{ old('email') }}">
